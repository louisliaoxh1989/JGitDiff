...
public class Diff_match_patch {
   ...
   * @return HTML representation.
   */
  public String diff_prettyHtmlRbb(LinkedList<Diff> diffs) {
    StringBuilder html = new StringBuilder();
    int i = 0;
    for (Diff aDiff : diffs) {
      String text = aDiff.text.replace("&", "&amp;").replace("<", "&lt;")
      ...
      switch (aDiff.operation) {
      case INSERT:
        html.append("<INS STYLE=\"background:#7CFC00;\" TITLE=\"i=").append(i)
            .append("\">").append(text).append("</INS>");
        break;
      case DELETE:
        html.append("<DEL STYLE=\"background:#B22222;\" TITLE=\"i=").append(i)
            .append("\">").append(text).append("</DEL>");
        break;
      case EQUAL:
        html.append("<SPAN TITLE=\"i=").append(i).append("\">").append(text)
